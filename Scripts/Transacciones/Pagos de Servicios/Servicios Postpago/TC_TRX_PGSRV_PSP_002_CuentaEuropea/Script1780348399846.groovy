...
WebUI.selectOptionByValue(findTestObject('Page_Banco Promerica - Banca en Linea/select_AccountFromStr'), '27459690481', 
    false)
...
WebUI.verifyElementVisible(findTestObject('Page_Banco Promerica - Banca en Linea/Page_Banco Promerica - Banca en Linea/div_Ha ocurrido un error efectuando una operaci'), 
    FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Page_Banco Promerica - Banca en Linea/Page_Banco Promerica - Banca en Linea/button_Cerrar_1'))
